...
public class ListCatFilterPopupAdapter extends BaseAdapter {
    ...
    public ListCatFilterPopupAdapter(FilterActivity activity, List<MainCategory> sampleData, ListPopupWindowAdapter.OnClickDeleteButtonListener onClickDeleteButtonListener) {
