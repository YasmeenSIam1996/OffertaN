...
public class ViewPagerAdapterImage extends PagerAdapter {
    ...
    private List<Advertisement> mResources;

    public ViewPagerAdapterImage(Context mContext, List<Advertisement> mResources) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        Picasso.with(mContext).load(Constants.Image_URL + mResources.get(position).getImage())
