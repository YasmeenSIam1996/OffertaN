...
public class ListSizeFilterPopupAdapter extends BaseAdapter {
    private Activity mActivity;
    private List<SizeFilter> mDataSource ;
    private LayoutInflater layoutInflater;
    private ListPopupWindowAdapter.OnClickDeleteButtonListener clickDeleteButtonListener;



    public ListSizeFilterPopupAdapter(FilterActivity activity, List<SizeFilter> sampleData, ListPopupWindowAdapter.OnClickDeleteButtonListener onClickDeleteButtonListener) {
